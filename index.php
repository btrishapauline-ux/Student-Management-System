...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a class="btn-getstarted" href="#" id="loginTriggerBtn">Sign In</a>
  ...
  <main class="main">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            ...
            <h4> BU has 21 academic units: </h4>
            <h4>East Campus:</h4>
            <ol>
            ...
            <ol>
              ...
              <li> College of Arts and Letters </li>
              <li> College of Nursing </li>
              <li> College of Law </li>
              <li> Graduate School </li>
              <li> Institute of Physical Education, Sports and Recreation </li>
              <li> Integrated Laboratory School </li>
              <li> Open University </li>
              <li> College of Education </li>
              <li> College of Medicine </li>
              <li> Jesse M. Robredo Institute of Governance and Development  </li>
              <li> College of Dental Medicine </li>
            </ol>

            <h4>Daraga Campus:</h4>
            <ol>
              <li> College of Social Sciences and Philosophy </li>
              <li> College of Business Economics and Management </li>
            </ol>

            <h4>Guinobatan, Albay:</h4>
            <ol>
            ...
            <h4>Polangui, Albay</h4>
            <ol>
              <li> Polangui Campus </li>
            </ol>

            <h4>Gubat, Sorsogon</h4>
            <ol>
              <li> Gubat Campus </li>
            </ol>
          </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <p>With 7 campuses scattered across the region, BU is home to top notchers in the fields of Accountancy, Engineering, Midwifery, Nursing, Social Work and Education. </p>
            <p>As a comprehensive university, it caters to the needs of the society in the following fields: </p>
            <ul>
              <li>Technology, Engineering, Architecture and Sciences</li>
              <li>Arts and Letters, Culture, Recreation and Sports</li>
    ...
    <section id="call-to-action" class="call-to-action section dark-background">
      ...
      <img src="assets/img/bu.jpeg" alt="">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.php" class="d-flex align-items-center">
            <span class="sitename">Student Management System</span>
          </a>
